...
class ErrorResponse(object):
    ...
    def __init__(self, code=None, message=None, id=None):  # noqa: E501
    ...
    def code(self):
        ...
        The error code (mostly the HTTP status description)  # noqa: E501
    ...
    def message(self):
        ...
        A detailed message of the error that helps you to correct your request.  # noqa: E501
    ...
    def id(self):
        ...
        The request ID which can be used for investigation purposes.  # noqa: E501
