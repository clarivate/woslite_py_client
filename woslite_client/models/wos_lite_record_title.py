...
class WosLiteRecordTitle(object):
    ...
    def __init__(self, title=None):  # noqa: E501
        """WosLiteRecordTitle - a model defined in Swagger"""  # noqa: E501
        self._title = None
    ...
    @property
    def title(self):
        """Gets the title of this WosLiteRecordTitle.  # noqa: E501


        :return: The title of this WosLiteRecordTitle.  # noqa: E501
        :rtype: list[str]
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this WosLiteRecordTitle.


        :param title: The title of this WosLiteRecordTitle.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WosLiteRecordTitle, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WosLiteRecordTitle):
            return False
